	...
	return (
		<Link
			...
			className={cn(
				...
				"underline decoration-current/50 underline-offset-2 data-[underline=hover]:hover:decoration-current data-[underline=none]:no-underline sm:data-[underline=hover]:decoration-transparent",
