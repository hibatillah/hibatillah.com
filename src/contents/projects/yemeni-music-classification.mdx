...
import thumbnail from "@/static/project/yemeni-music/thumbnail.webp"
...
- Backend - A robust API that receives the audio, processes it, and serves the _Deep Learning_ model.
